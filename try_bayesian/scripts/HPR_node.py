...
if __name__ == '__main__':    
    ...
    while not rospy.is_shutdown():
        ...
        # save_view_point(pcd_cut, "/home/loris/ply_and_stl/json_o3d/hpr_view_1366.json")
        ...
        if j==0:  
            ...
            param = o3d.io.read_pinhole_camera_parameters("/home/loris/ply_and_stl/json_o3d/hpr_view_1366_400_p_caso.json")
            ctr = vis.get_view_control()
            ctr.convert_from_pinhole_camera_parameters(param)
            vis.get_render_option().load_from_json("/home/loris/ply_and_stl/json_o3d/hpr.json")
