...
if __name__ == '__main__':    
    ...
    while not rospy.is_shutdown():
        ...
        #aspetto che il training sia finito per inviare il messaggio
        
        if j==0: 
            messaggio_training = rospy.wait_for_message("Training_Finished",String)
            print("\n messaggio ricevuto:",messaggio_training) 
