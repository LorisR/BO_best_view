...
while not rospy.is_shutdown():
    ...
    if sensor_start.start==1:
        ...
        print("MESSAGE RECEIVED: Publishing Octomap and acquiring Pointcloud")
        pipe_profile = pipeline.start(config)
        curr_frame = 0
        try:
