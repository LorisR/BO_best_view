...
#include <stdlib.h>
#include <iostream>
#include <planner_online/coord_msg_online.h>
#include <planner_online/pose.h>
#include <ctime>
#include <cstdio>
#include <iostream>
#include <fstream>
...
std::string name_scan;
planner_online::coord_msg_online msg_da_pubb;
planner_online::pose pose_msg;
...
std::string nome_file_halcon = "halcon_online_";
int only_one = 0;
int jj = 0;
double pose[10];
...
{ ros::NodeHandle m;
  ...
  ros::Publisher halcon_pub_pose = m.advertise<planner_online::pose>("halcon_publish_pose", 1000);
  ...
  valoreparam = readline(name_file,49,"{","}");
...
#endif
void chatterCallback(const planner_online::coord_msg_online::ConstPtr& msg_da_pubb)
{ 
  ...
  std::cout<<"la qx vale:" << msg_da_pubb->qx <<"\n";
  std::cout<<"la qy vale:" << msg_da_pubb->qy<<"\n"; 
  std::cout<<"la qz vale:" << msg_da_pubb->qz<<"\n";
  std::cout<<"la qw vale:" << msg_da_pubb->qw <<"\n";
  

  dir_dati_salv = readline(name_file,46,"{","}");
  if(only_one == 0){
