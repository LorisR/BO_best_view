...
{ ros::NodeHandle m;
  ...
  HTuple  hv_PoseOut, hv_FileViste, hv_View, hv_Status1,hv_View_1;
  HTuple  hv_MinScore, hv_Pose, hv_Score, hv_Surface,hv_SurfaceMatchingResult;
  ...
  SampleObjectModel3d(hv_Scan,"fast",scene_samp_dist,HTuple(),HTuple(),&hv_Scan);
