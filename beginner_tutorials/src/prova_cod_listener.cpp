///////////////////////////////////////////////////////////////////////////////
// File generated by HDevelop for HALCON/C++ Version 18.11.3.0
...
#include <stdlib.h>
#include <iostream>
#include <beginner_tutorials/coord_msg_checked.h>
...
#include <string>
std::ofstream myfile;
std::string valoreparam;
beginner_tutorials::coord_msg_checked msg_da_pubb;
beginner_tutorials::pose pose_msg;
std::string estensione = ".txt";
std::string name_file ="/home/loris/ply_and_stl/param.txt";
std::string  dir_dati_salv,tempo,nome_file_completo;
std::string nome_file_halcon = "halcon_";
int only_one = 0;
int jj = 0;
double pose[10];
//nome del file parametri da utilizzae
...
#endif
// funzione per leggere la linea da file
...
void inspect_normal_direction (HObject ho_MenuRegions, HTuple hv_WindowHandle1, HTuple hv_WindowHandle2, 
    HTuple hv_WindowHandleMenu, HTuple hv_SurfaceModelID, HTuple hv_ObjectModel3DScene, 
    HTuple hv_RelSamplingDistance, HTuple hv_KeyPointFraction, HTuple hv_MinScore, 
    HTuple hv_GenParamNames, HTuple hv_GenParamValues, HTuple hv_SurfaceMatchingResultID, 
    HTuple hv_MenuText, HTuple hv_CurrentCase, HTuple hv_CasesDone, HTuple hv_FontSize, 
    HTuple *hv_CreateNames, HTuple *hv_CreateValues, HTuple *hv_FindNames, HTuple *hv_FindValues);
// Chapter: 3D Object Model / Features
...
void set_edge_parameter_sliders (HTuple hv_WindowHandle, HTuple hv_ObjectModel3D, 
    ...
    HTuple hv_AmplitudeRange, HTuple hv_MaxGapRange, HTuple hv_Viewpoint, HTuple *hv_MinAmplitude, 
    HTuple *hv_MaxGap);
// Chapter: Graphics / Output
    ...
    HTuple hv_ObjectModel3DScene, HTuple hv_GenParamNames, HTuple hv_GenParamValues)
{
  ...
  HTuple  hv_Pos, hv_MedianDensity, hv_MLSNormals, hv_NormalPos;
  HTuple  hv_CheckNormals, hv_NX, hv_NY, hv_NZ, hv_Length;
  HTuple  hv_LengthOne, hv_LengthNotOne, hv_Rows, hv_Cols;
  HTuple  hv_MappingAsString, hv_CenterFromOrigin, hv_CenterToDiameter;
  HTuple  hv_NumSparsePoints, hv_MedianDirectionX, hv_MedianDirectionXNorm;
  HTuple  hv_MedianDirectionY, hv_MedianDirectionYNorm, hv_ErrorX;
  HTuple  hv_ErrorY, hv_DistanceOriginRel, hv_OM3D3DEdges;
  ...
  //*****************************************************************
  if (0 != (HTuple(int((hv_SurfaceModel.TupleLength())!=1)).TupleOr(int((hv_ObjectModel3DScene.TupleLength())!=1))))
  {
  ...
  if (0 != (int(hv_NumScenePoints>0)))
  {
    ...
    if (0 != (int((HTuple(hv_IsNaN.TupleOr(hv_IsInf)).TupleSum())>0)))
    {
  ...
  if (0 != (int(hv_NumScenePoints>0)))
  {
    ...
    if (0 != (int(hv_MaxNumNeighbors>30)))
    {
  ...
  if (0 != (HTuple(int(hv_NormalPos!=-1)).TupleAnd(int(hv_NormalPos!=HTuple()))))
  {
    hv_MLSNormals = int(HTuple(hv_GenParamValues[hv_NormalPos])==HTuple("mls"));
  }

  hv_CheckNormals = 0;
  if (0 != (int(hv_MLSNormals==1)))
  {
    write_note(hv_WindowHandle, "ok", "Normals computed with MLS method");
  }
  else if (0 != (int(hv_HasPointNormals==HTuple("true"))))
  {
    write_note(hv_WindowHandle, "ok", "Scene contains normals vectors");
    hv_CheckNormals = 1;
  }
  else if (0 != (int(hv_HasMapping==HTuple("true"))))
  {
  ...
  if (0 != hv_CheckNormals)
  {
    ...
    if (0 != (HTuple(int(hv_LengthNotOne>((hv_Length.TupleLength())*0.05))).TupleOr(int(hv_LengthNotOne>10))))
    {
  ...
  //*****************************************************************
  if (0 != (int(hv_HasMapping==HTuple("true"))))
  {
    ...
    if (0 != (HTuple(HTuple(HTuple(int(((hv_Rows.TupleLessElem(0)).TupleSum())>0)).TupleOr(int(((hv_Cols.TupleLessElem(0)).TupleSum())>0))).TupleOr(int(((hv_Rows.TupleGreaterElem(100000)).TupleSum())>0))).TupleOr((hv_Cols.TupleGreaterElem(1000000)).TupleSum())))
    {
    ...
    else
    {
      ...
      if (0 != (int((hv_MappingAsString.TupleLength())!=(hv_Rows.TupleLength()))))
      {
  ...
  if (0 != (int(hv_CenterToDiameter>10)))
  {
  ...
  //*****************************************************************
  if (0 != (HTuple(int(hv_HasTriangles==HTuple("true"))).TupleOr(int(hv_HasPolygons==HTuple("true")))))
  {
  ...
  if (0 != (int(hv_NumScenePoints>0)))
  {
    ...
    if (0 != (HTuple(int(hv_NumSparsePoints>20)).TupleOr(int(hv_NumSparsePoints>(0.05*hv_NumScenePoints)))))
    {
  ...
  //*****************************************************************
  if (0 != (int(hv_EdgesTrained==HTuple("false"))))
  {
  ...
  if (0 != (int(hv_EdgesTrained==HTuple("true"))))
  {
    if (0 != (int(hv_HasMapping==HTuple("false"))))
    {
  ...
  //*****************************************************************
  if (0 != (HTuple(int(hv_EdgesTrained==HTuple("true"))).TupleAnd(int(hv_HasMapping==HTuple("true")))))
  {
    ...
    if (0 != (int((((hv_MedianDirectionX*hv_MedianDirectionX).TupleSum()).TupleSqrt())>1e-8)))
    {
    ...
    if (0 != (int((((hv_MedianDirectionY*hv_MedianDirectionY).TupleSum()).TupleSqrt())>1e-8)))
    {
    ...
    if (0 != (HTuple(int((((hv_ErrorX*hv_ErrorX).TupleSum()).TupleSqrt())>0.2)).TupleOr(int((((hv_ErrorY*hv_ErrorY).TupleSum()).TupleSqrt())>0.2))))
    {
  ...
  //*****************************************************************
  if (0 != (HTuple(int(hv_HasPointNormals==HTuple("false"))).TupleAnd(int(hv_HasMapping==HTuple("true")))))
  {
    hv_DistanceOriginRel = (((hv_CenterScene*hv_CenterScene).TupleSum()).TupleSqrt())/hv_DiameterModel;
    if (0 != (HTuple(HTuple(HTuple(HTuple(HTuple(int(HTuple(hv_BBox[0])<0)).TupleAnd(int(HTuple(hv_BBox[1])<0))).TupleAnd(int(HTuple(hv_BBox[2])<0))).TupleAnd(int(HTuple(hv_BBox[3])>0))).TupleAnd(int(HTuple(hv_BBox[4])>0))).TupleAnd(int(HTuple(hv_BBox[5])>0))))
    {
  ...
  if (0 != (HTuple(int(hv_EdgesTrained==HTuple("true"))).TupleAnd(int(hv_OM3D3DEdges==HTuple()))))
  {
  ...
  if (0 != (int(hv_HasMapping==HTuple("true"))))
  {
    ...
    hv_ZSigmaPct = ((hv_ZSigmaRel*100).TupleString(".2"))+"%";
    if (0 != (int(hv_ZSigmaRel>0.2)))
    {
    ...
    else if (0 != (int(hv_ZSigmaRel>0.1)))
    {
    ...
    HTuple hv_WindowHandleVisualization)
{
  ...
  HTuple  hv_Center, hv_PoseInT, hv_PoseInR, hv_PoseIn, hv_CamParamVis;
  HTuple  hv_PoseEstimated, hv_MessageQueues2, hv_DirectionsShown;
  HTuple  hv_CurrentState2, hv_DidFinish1, hv_ButtonPressed;
  HTuple  hv_Pose, hv_PoseInvert, hv_Direction, hv_Length;
  HTuple  hv_OM3DSphere, hv_OM3DModelEdges, hv_EdgeDirs, hv_MessageHandle;
  HTuple  hv_DidFinish2, hv_TIT;
  ...
  CreatePose(-HTuple(hv_Center[0]), -HTuple(hv_Center[1]), -HTuple(hv_Center[2]), 
      0, 0, 0, "Rp+T", "gba", "point", &hv_PoseInT);
  CreatePose(0, 0, 0, -90, 0, 0, "Rp+T", "gba", "point", &hv_PoseInR);
  PoseCompose(hv_PoseInR, hv_PoseInT, &hv_PoseIn);
  ...
  do
  {
    ...
    if (0 != (int(hv_ButtonPressed==0)))
    {
      //Exit button
      break;
    }
    if (0 != (int(hv_Pose!=HTuple())))
    {
      ...
      GenObjectModel3dFromPoints(HTuple(hv_Viewpoint[0]).TupleConcat(HTuple(hv_CenterModel[0])), 
          ...
          &hv_OM3DLineSphereToModel);
      SetObjectModel3dAttribMod(hv_OM3DLineSphereToModel, "lines", HTuple(), ((HTuple(2).Append(0)).Append(1)));
      GetSurfaceModelParam(hv_SurfaceModelID, "edges "+(((hv_Viewpoint-hv_CenterModel)+" ").TupleSum()), 
          &hv_OM3DModelEdges);
      //
      GetObjectModel3dParams(hv_OM3DModelEdges, HTuple("edge_dir_")+((HTuple("x").Append("y")).Append("z")), 
          &hv_EdgeDirs);
      if (0 != (int((hv_EdgeDirs.TupleLength())>0)))
      {
    ...
    HTuple *hv_FoundButton)
{
  ...
  {
    if (0 != (HTuple(HTuple(HTuple(int(hv_GraphButtonRow>=(HTuple(hv_gButtons[hv_idx+2])-1))).TupleAnd(int(hv_GraphButtonRow<=(HTuple(hv_gButtons[hv_idx+4])+1)))).TupleAnd(int(hv_GraphButtonColumn>=(HTuple(hv_gButtons[hv_idx+1])-1)))).TupleAnd(int(hv_GraphButtonColumn<=(HTuple(hv_gButtons[hv_idx+3])+1)))))
    {
    ...
    HTuple *hv_FindSurfaceModelParamValue)
{
  ...
  HTuple  hv_WindowHandle1, hv_WindowHandle2, hv_Row, hv_Column;
  HTuple  hv_Width, hv_Height, hv_HasEdges, hv_MenuText, hv_MenuCode;
  HTuple  hv_TopBottom, hv_NumCols, hv_NumRows, hv_PercentageHeight;
  HTuple  hv_CheckedCase, hv_Case, hv_RowButtons0, hv_ColumnButtons0;
  HTuple  hv_RowButtons1, hv_ColumnButtons1, hv_MenuBottom;
  HTuple  hv_RelSamplingDistance, hv_KeyPointFraction, hv_MinScore;
  HTuple  hv_GenParamNames, hv_GenParamValues, hv_NumPoses;
  HTuple  hv_Pose, hv_Score, hv_Index, hv_CurrPose, hv_CurrScore;
  HTuple  hv_Exception, hv_CasesDone, hv_CurrentCase, hv_MaxGap;
  HTuple  hv_MinAmplitudeAbs, hv_Viewpoint, hv_LastException;
  HTuple  hv_UserProvidedEdges, hv_ModelDiameter, hv_ViewpointStr;
  HTuple  hv_MinAmplitudeRel, hv_OM3DProvidedEdges, hv_NormalParamsSet;
  HTuple  hv_ErrorMessage, hv_Message, hv_CreateName, hv_CreateValue;
  ...
  hv_WindowHandle1 = HTuple();
  hv_WindowHandle2 = HTuple();
  //
  ...
  if (0 != (int((hv_SurfaceMatchingResultID.TupleLength())==0)))
  {
    if (0 != (int(hv_HasEdges==HTuple("true"))))
    {
      hv_MenuText.Clear();
  ...
  if (0 != (int((hv_SurfaceMatchingResultID.TupleLength())>0)))
  {
    ...
    if (0 != (int(hv_RelSamplingDistance==0)))
    {
      HDevWindowStack::SetActive(hv_WindowHandleMenu);
      if (HDevWindowStack::IsOpen())
        ClearWindow(HDevWindowStack::GetActive());
  ...
  hv_Viewpoint = HTuple();
  hv_LastException = HTuple();
  hv_UserProvidedEdges = 0;
  if (0 != (HTuple(int(hv_HasEdges==HTuple("true"))).TupleAnd(int((hv_SurfaceMatchingResultID.TupleLength())>0))))
  {
    ...
    if (0 != (int(hv_MinAmplitudeRel!=HTuple())))
    {
    ...
    hv_UserProvidedEdges = int((hv_OM3DProvidedEdges.TupleLength())>0);
  }
  ...
  while (0 != 1)
  {
    ...
    if (0 != (int(hv_LastException!=HTuple())))
    {
      HException::GetExceptionData(hv_LastException,"error_message",&hv_ErrorMessage);
      write_note(hv_WindowHandleMenu, "warning", ("Exception while running tool: "+hv_ErrorMessage).TupleConcat(HTuple("The scene, model or edges might be empty. Try the Automatic Value Check first.")));
      hv_LastException = HTuple();
    }
    select_case(ho_MenuRegions, hv_WindowHandleMenu, hv_MenuText, &hv_CurrentCase);
    if (0 != (int(hv_CurrentCase==-1)))
    {
      //Window was closed -> abort
      break;
    }
    if (0 != (int(HTuple(hv_MenuCode[hv_CurrentCase])==HTuple("exit"))))
    {
      break;
    }
    ...
    try
    {
      ...
      //****************************
      if (0 != (int(HTuple(hv_MenuCode[hv_CurrentCase])==HTuple("normals"))))
      {
        HDevWindowStack::SetActive(hv_WindowHandleMenu);
        SetTposition(hv_WindowHandleMenu, hv_MenuBottom+6, 1);
      ...
      //***************************
      //
      if (0 != (int(HTuple(hv_MenuCode[hv_CurrentCase])==HTuple("check"))))
      {
      ...
      //****************
      //
      if (0 != (int(HTuple(hv_MenuCode[hv_CurrentCase])==HTuple("scene_edge_params"))))
      {
        HDevWindowStack::SetActive(hv_WindowHandleMenu);
        SetTposition(hv_WindowHandleMenu, hv_MenuBottom+6, 1);
      ...
      //******************
      //
      if (0 != (int(HTuple(hv_MenuCode[hv_CurrentCase])==HTuple("scene_edge_dirs"))))
      {
        HDevWindowStack::SetActive(hv_WindowHandleMenu);
        SetTposition(hv_WindowHandleMenu, hv_MenuBottom+6, 1);
      ...
      //***************************
      //
      if (0 != (int(HTuple(hv_MenuCode[hv_CurrentCase])==HTuple("model_edges"))))
      {
        //Update the visualization of the menue
        HDevWindowStack::SetActive(hv_WindowHandleMenu);
        SetTposition(hv_WindowHandleMenu, hv_MenuBottom+6, 1);
      ...
      //***************************
      //
      if (0 != (int(HTuple(hv_MenuCode[hv_CurrentCase])==HTuple("results"))))
      {
        //Update the visualization of the menue
        HDevWindowStack::SetActive(hv_WindowHandleMenu);
        SetTposition(hv_WindowHandleMenu, hv_MenuBottom+6, 1);
...
void dev_close_window_if_open (HTuple hv_WindowHandle)
{
  ...
  // Local control variables
  HTuple  hv_CurrWindowHandle, hv_Exception;
  ...
  try
  {
    ...
    if (0 != (int(hv_CurrWindowHandle==hv_WindowHandle)))
    {
      if (HDevWindowStack::IsOpen())
        CloseWindow(HDevWindowStack::Pop());
    }
    ...
    HTuple hv_CasesDone, HTuple hv_CurrentCase)
{
  ...
  if (0 != (int(hv_NumberRegions<hv_NumberTexts)))
  {
  ...
  for (hv_i=1; hv_i.Continue(end_val10, step_val10); hv_i += step_val10)
  {
    ...
    hv_Done = 0;
    if (0 != (int((hv_i-1)==hv_CurrentCase)))
    {
      SetColor(hv_WindowHandleMenu, "#FA8072");
    }
    else if (0 != (HTuple(int(hv_Indices!=-1)).TupleAnd(int(hv_Indices!=HTuple()))))
    {
    ...
    HTuple hv_Information)
{
  ...
  {
    hv_Row = 12;
    if (0 != (int(hv_gTitlePos==HTuple("UpperLeft"))))
    {
      hv_Column = 12;
    }
    else if (0 != (int(hv_gTitlePos==HTuple("UpperCenter"))))
    {
      max_line_width(hv_WindowHandle, hv_Title, &hv_TextWidth);
      hv_Column = (hv_WinWidth/2)-(hv_TextWidth/2);
    }
    else if (0 != (int(hv_gTitlePos==HTuple("UpperRight"))))
    {
      if (0 != (int(HTuple(hv_gTitleDecor[1])==HTuple("true"))))
      {
        max_line_width(hv_WindowHandle, hv_Title+"  ", &hv_TextWidth);
      }
      else
  ...
  {
    if (0 != (int(hv_gInfoPos==HTuple("UpperLeft"))))
    {
      hv_Row = 12;
      hv_Column = 12;
    }
    else if (0 != (int(hv_gInfoPos==HTuple("UpperRight"))))
    {
      if (0 != (int(HTuple(hv_gInfoDecor[1])==HTuple("true"))))
      {
    ...
    else if (0 != (int(hv_gInfoPos==HTuple("LowerLeft"))))
    {
    ...
    HTuple hv_ViewPoint)
{
  ...
  {
    if (0 != (int(hv_gUsesOpenGL==HTuple("true"))))
    {
      try
      {
        DisplayScene3d(hv_WindowHandleBuffer, hv_Scene3D, 0);
    ...
    if (0 != (int(hv_gUsesOpenGL==HTuple("false"))))
    {
  ...
  if (0 != (int(hv_DispViewPoint==HTuple("true"))))
  {
  ...
  if (0 != (int(hv_DisplayButtons==HTuple("true"))))
  {
...
void estimate_noise_real (HObject ho_Image, HTuple hv_OutlierRemovalAmount, HTuple *hv_Sigma)
{
  ...
  if (0 != (int((hv_Rows.TupleLength())<30)))
  {
  ...
  else
  {
    ...
    if (0 != (int(hv_OutlierRemovalAmount>0)))
    {
    ...
    HTuple *hv_PoseEstimated)
{
  ...
  HTuple  hv_Exception, hv_PoseInvert, hv_ObjectModel3DRigidTrans;
    ...
    HTuple *hv_OM3DCamera)
{
  ...
  if (0 != (int(hv_DirectionLength<(1e-1*hv_DiameterModel))))
  {
  ...
  else
  {
    ...
    if (0 != (int(((hv_DirNorm*((HTuple(0).Append(0)).Append(-1))).TupleSum())>-0.99999)))
    {
    ...
    HTuple hv_PercentageHeight, HTuple hv_NumRows, HTuple hv_NumCols)
{
  ...
  if (0 != (HTuple(int(hv_TopBottom!=HTuple("top"))).TupleAnd(int(hv_TopBottom!=HTuple("bottom")))))
  {
  ...
  if (0 != (int(hv_TopBottom==HTuple("top"))))
  {
    hv_Row0 = hv_PartRow1;
  }
  if (0 != (int(hv_TopBottom==HTuple("bottom"))))
  {
...
void get_cam_par_names (HTuple hv_CameraParam, HTuple *hv_CameraType, HTuple *hv_ParamNames)
{
  ...
  if (0 != (HTuple(int((hv_CameraParam.TupleLength())==1)).TupleAnd(HTuple(hv_CameraParam[0]).TupleIsString())))
  {
    ...
    else if (0 != (int((*hv_CameraType)==HTuple("line_scan"))))
    {
      (*hv_ParamNames).Clear();
      (*hv_ParamNames)[0] = "camera_type";
    ...
    HTuple hv_DefaultValue, HTuple *hv_ParamValue)
{
  ...
  if (0 != (HTuple(int(hv_Idx!=-1)).TupleAnd(int(hv_Idx!=HTuple()))))
  {
...
void get_image_direction (HObject ho_Image, HTuple *hv_MedianDirection)
{
  ...
  if (0 != (int((hv_Columns.TupleLength())>0)))
  {
    ...
    HTuple *hv_Row, HTuple *hv_Column, HTuple *hv_Button)
{
  ...
  (*hv_Button) = -1;
  //
  if (0 != (int(hv_MessageQueue==HTuple())))
  {
  ...
  else
  {
    ...
    else
    {
      ...
      catch (HException &HDevExpDefaultException)
      {
        ...
        if (0 != (int(HTuple(hv_Exception[0])==hv_H_ERR_TIMEOUT)))
        {
          return;
        }
        else
    ...
    if (0 != (int(hv_MessageType==HTuple("mouse_event"))))
    {
    ...
    HTuple *hv_CreateNames, HTuple *hv_CreateValues, HTuple *hv_FindNames, HTuple *hv_FindValues)
{
  ...
  HTuple  hv_VC_P_Model, hv_VC_P_Scene, hv_NXYZOrig, hv_MessageQueues1;
  HTuple  hv_Buttons, hv_ShowNormals1, hv_MessageQueues2;
  HTuple  hv_ShowNormals2, hv_PreviousState1, hv_PreviousState2;
  HTuple  hv_DidFinish1, hv_DidFinish2, hv_Row, hv_Column;
  HTuple  hv_Width, hv_Height, hv_WindowHandleBufferMenu;
  ...
  GetSurfaceMatchingResult(hv_SurfaceMatchingResultID, "model_invert_normals", HTuple(), 
      &hv_NormalsInverted);
  if (0 != (int(hv_NormalsInverted==HTuple("true"))))
  {
  ...
  GetObjectModel3dParams(hv_ObjectModel3DScene, "has_point_normals", &hv_SceneHasNormals);
  if (0 != (int(hv_SceneHasNormals==HTuple("true"))))
  {
  ...
  if (0 != (int(hv_NormalCompMode==HTuple("fast"))))
  {
    hv_Message[2] = "Scene normals are computed based on the fast method "+hv_FastMethod;
  }
  else if (0 != (int(hv_NormalCompMode==HTuple("mls"))))
  {
  ...
  do
  {
    ...
    if (0 != (HTuple(int(hv_ButtonPressed==0)).TupleOr(hv_DidFinish1)))
    {
      //Exit-button
      break;
    }
    else if (0 != (int(hv_ButtonPressed==1)))
    {
      //Invert Normals
      GetObjectModel3dParams(hv_SampledModel, HTuple("point_normal_")+((HTuple("x").Append("y")).Append("z")), 
          &hv_NXYZ);
    ...
    else if (0 != (int(hv_ButtonPressed==2)))
    {
      //Toggle normals
    ...
    else if (0 != (int(hv_ButtonPressed==1)))
    {
      ...
      if (0 != (int(hv_SceneFast==HTuple())))
      {
        FindSurfaceModel(hv_SurfaceModelID, hv_ObjectModel3DScene, hv_RelSamplingDistance, 
            0.00001, 0, "true", ((HTuple("dense_pose_refinement").Append("sparse_pose_refinement")).Append("scene_normal_computation")), 
    ...
    HTuple hv_MaxGapIn, HTuple hv_MinAmplitudeIn, HTuple hv_ViewpointIn, HTuple *hv_Viewpoint)
{
  ...
  HTuple  hv_Exception, hv_CenterSceneGravity, hv_OM3DCamera;
  HTuple  hv_OM3DLineSphereToScene, hv_DirectionLength, hv_ViewpointAsPoseIn;
  HTuple  hv_DirNorm, hv_Axis, hv_AxisNorm, hv_OrthogonalDirection;
  HTuple  hv_RotationAxis, hv_DirectionProjected, hv_AngleToX;
  HTuple  hv_HomMat3DIdentity, hv_HomMat3DRotate, hv_Instructions;
  HTuple  hv_Row, hv_Column, hv_Width, hv_Height, hv_CameraParam;
  HTuple  hv_Buttons, hv_MessageQueues1, hv_PreviousState1;
  HTuple  hv_DidFinish1, hv_VizCenter, hv_HomMat3DIdentity1;
  HTuple  hv_PoseIn, hv_VizposeIn, hv_ShowViewDir, hv_ShowEdgeDir;
  HTuple  hv_MessageQueues2, hv_PreviousState2, hv_ButtonPressed;
  HTuple  hv_Pose, hv_MessageHandle, hv_HomMat3D, hv_HomMat3DInvert;
  HTuple  hv_Qx, hv_Qy, hv_Qz, hv_DidFinish2, hv_Poses, hv_TIT;
  HTupleVector  hvec_TI(1);
  ...
  catch (HException &HDevExpDefaultException)
  {
    ...
    GenEmptyObjectModel3d(&hv_ObjectModel3DEdges);
    GenEmptyObjectModel3d(&hv_ObjectModel3DEdgeDirs);
  }
  //
    ...
    HTuple *hv_CurrentState, HTuple *hv_DidFinish)
{
  ...
  // Local control variables
  HTuple  hv_MessageHandle, hv_Type, hv_Exception;
  HTuple  hv_Row, hv_Column, hv_Button, hv_Current, hv_MessageHandleIgnore;
  ...
  try
  {
    try
    {
      ...
      if (0 != (int(hv_Type==HTuple("done"))))
      {
        //The visualization function has finished and has exited
        (*hv_DidFinish) = 1;
      }
      else if (0 != (int(hv_Type==HTuple("exception"))))
      {
        (*hv_DidFinish) = 1;
        GetMessageTuple(hv_MessageHandle, "exception", &hv_Exception);
        throw HException(hv_Exception);
      }
      else
      {
    ...
    catch (HException &HDevExpDefaultException)
    {
      ...
      if (0 != (int(HTuple(hv_Exception[0])!=9400)))
      {
        throw HException(hv_Exception);
      }
    }
    ...
    if (0 != (int(hv_Current!=hv_PreviousState)))
    {
      CreateMessage(&hv_MessageHandle);
  ...
  {
    HDevExpDefaultException.ToHTuple(&hv_Exception);
    if (0 != (int(HTuple(hv_Exception[0])==2891)))
    {
    ...
    else if (0 != (HTuple(int(HTuple(hv_Exception[0])==5)).TupleAnd(int(HTuple(hv_Exception[5])==HTuple("get_mposition_sub_pix")))))
    {
      //Mouse not in window
      //Ignore
      WaitSeconds(0.01);
    }
    else if (0 != (HTuple(int(HTuple(hv_Exception[0])==2454)).TupleOr(int(HTuple(hv_Exception[0])==5100))))
    {
    ...
    HTuple *hv_Poses)
{
  ...
  // Local control variables
  HTuple  hv_MessageHandle, hv_Type, hv_Exception;
  HTuple  hv_ButtonID, hv_Row, hv_Column, hv_Button, hv_Current;
    ...
    HTuple *hv_SelectedCase)
{
  ...
  while (0 != 1)
  {
    ...
    {
      HDevExpDefaultException.ToHTuple(&hv_Exception);
      if (0 != (HTuple(int(HTuple(hv_Exception[0])==2454)).TupleOr(int(HTuple(hv_Exception[0])==5100))))
      {
        //Handle was already cleared -> indicates that the window was closed (by the user)
        //Abort gracefully.
        (*hv_SelectedCase) = -1;
      ...
      else if (0 != (int(HTuple(hv_Exception[0])==5)))
      {
    ...
    HTuple *hv_MaxGap)
{
  ...
  try
  {
    ...
    try
    {
      while (0 != 1)
      {
        EdgesObjectModel3d(hv_ObjectModel3D, (*hv_MinAmplitude)*hv_ModelDiameter, 
            (HTuple("max_gap").Append("viewpoint")), (*hv_MaxGap).TupleConcat(hv_ViewpointStr), 
        ...
        EnqueueMessage(HTuple(hv_MessageQueueOut[1]), hv_MessageHandle, HTuple(), 
            HTuple());
        //
        ...
        {
          get_mouse_info(hv_WindowHandle, hv_MessageQueues, 0.01, &hv_MouseRow, &hv_MouseColumn, 
              &hv_MouseButton);
          //
          //Find the slider the mouse is in
          hv_Slider = HTuple();
          if (0 != (HTuple(HTuple(HTuple(int(hv_MouseRow>hv_RowSlider1)).TupleAnd(int(hv_MouseRow<(hv_RowSlider1+hv_SliderHeight)))).TupleAnd(int(hv_MouseColumn>=hv_ColSliderStart))).TupleAnd(int(hv_MouseColumn<=hv_ColSliderEnd))))
          {
            hv_Slider = 1;
          }
          else if (0 != (HTuple(HTuple(HTuple(int(hv_MouseRow>hv_RowSlider2)).TupleAnd(int(hv_MouseRow<(hv_RowSlider2+hv_SliderHeight)))).TupleAnd(int(hv_MouseColumn>=hv_ColSliderStart))).TupleAnd(int(hv_MouseColumn<=hv_ColSliderEnd))))
          {
            hv_Slider = 2;
          }
          //
          hv_UpdateSlider = 0;
          if (0 != (int(hv_MouseButton==1)))
          {
            if (0 != (int(hv_CurrentSliderActive==HTuple())))
            {
              if (0 != (int(hv_Slider!=HTuple())))
              {
          ...
          else if (0 != (int(hv_MouseButton==0)))
          {
            if (0 != (int(hv_CurrentSliderActive!=HTuple())))
            {
          ...
          if (0 != hv_UpdateSlider)
          {
            ...
            if (0 != (int(hv_ValueRel<0)))
            {
              hv_ValueRel = 0;
            }
            else if (0 != (int(hv_ValueRel>1)))
            {
              hv_ValueRel = 1;
            }

            if (0 != (int(1==hv_CurrentSliderActive)))
            {
              (*hv_MinAmplitude) = HTuple(hv_AmplitudeRange[0])+(hv_ValueRel*(HTuple(hv_AmplitudeRange[1])-HTuple(hv_AmplitudeRange[0])));
            }
            else if (0 != (int(2==hv_CurrentSliderActive)))
            {
              ...
              if (0 != (int((*hv_MaxGap)<HTuple(hv_MaxGapRange[0]))))
              {
                (*hv_MaxGap) = ((const HTuple&)hv_MaxGapRange)[0];
              }
              else if (0 != (int((*hv_MaxGap)>HTuple(hv_MaxGapRange[1]))))
              {
          ...
          try
          {
            DequeueMessage(HTuple(hv_MessageQueues[1]), "timeout", 0, &hv_MessageHandle);
            GetMessageTuple(hv_MessageHandle, "type", &hv_MessageType);
            if (0 != (int(hv_MessageType==HTuple("exit"))))
            {
              return;
            }
            else
  ...
  catch (HException &HDevExpDefaultException)
  {
    HDevExpDefaultException.ToHTuple(&hv_Exception);
    CreateMessage(&hv_MessageHandle);
    SetMessageTuple(hv_MessageHandle, "type", "exception");
    SetMessageTuple(hv_MessageHandle, "exception", hv_Exception);
    EnqueueMessage(HTuple(hv_MessageQueues[2]), hv_MessageHandle, HTuple(), HTuple());
  }
  return;
}
    ...
    HTuple hv_ViewPoint)
{
  ...
  HTuple  hv_Redraw, hv_RecreateScene3D, hv_GraphButtonRow;
  HTuple  hv_GraphButtonColumn, hv_GraphButton, hv_MessageHandle;
  HTuple  hv_MessageType, hv_Pos, hv_Angle, hv_Pose, hv_NewPoses;
  HTuple  hv_Index, hv_Model, hv_ButtonIndex, hv_ButtonText;
  HTuple  hv_FoundButton, hv_ButtonPressed, hv_FoundButton2;
  HTuple  hv_PoseOut;
  ...
  try
  {
    ...
    if (0 != (HTuple(int(hv_Indices!=-1)).TupleAnd(int(hv_Indices!=HTuple()))))
    {
      ...
      hv_GenParamName = hv_GenParamName.TupleRemove(hv_Indices);
      hv_GenParamValue = hv_GenParamValue.TupleRemove(hv_Indices);
      if (0 != (HTuple(int(hv_gUsesOpenGL!=HTuple("true"))).TupleAnd(int(hv_gUsesOpenGL!=HTuple("false")))))
      {
        //Wrong parameter value: Only 'true' and 'false' are allowed
        throw HException("Wrong value for parameter 'opengl' (must be either 'true' or 'false')");
      }
    ...
    //Finalize Buttons
    {
    HTuple end_val316 = (hv_Buttons.TupleLength())-1;
    HTuple step_val316 = 5;
    for (hv_idx=0; hv_idx.Continue(end_val316, step_val316); hv_idx += step_val316)
    {
      GetFontExtents(hv_WindowHandle, &hv_MaxAscent, &hv_MaxDescent, &hv_MaxWidth, 
          &hv_MaxHeight);
      GetStringExtents(hv_WindowHandleBuffer, HTuple(hv_Buttons[hv_idx+0])+"  ", 
          &hv_Ascent, &hv_Descent, &hv_TextWidth, &hv_TextHeight);
      hv_ButtonWidth = HTuple(hv_Buttons[hv_idx+3]);
      if (0 != (int(hv_ButtonWidth==-1)))
      {
        hv_ButtonWidth = hv_TextWidth;
      }
      hv_ButtonHeight = HTuple(hv_Buttons[hv_idx+4]);
      if (0 != (int(hv_ButtonHeight==-1)))
      {
        //Button border is of size 2
        hv_ButtonHeight = hv_MaxHeight;
      }
      //X position
      if (0 != (int(HTuple(hv_Buttons[hv_idx+1])==HTuple("right"))))
      {
        hv_Buttons[hv_idx+1] = (hv_Width-15)-hv_ButtonWidth;
      }
      else if (0 != (int(HTuple(hv_Buttons[hv_idx+1])==HTuple("left"))))
      {
        hv_Buttons[hv_idx+1] = 15;
      }
      else if (0 != (int(HTuple(hv_Buttons[hv_idx+1])==HTuple("center"))))
      {
      ...
      //Y position
      if (0 != (int(HTuple(hv_Buttons[hv_idx+2])==HTuple("bottom"))))
      {
        hv_Buttons[hv_idx+2] = (hv_Height-25)-hv_ButtonHeight;
      }
      else if (0 != (int(HTuple(hv_Buttons[hv_idx+2])==HTuple("top"))))
      {
        hv_Buttons[hv_idx+2] = 25;
      }
      else if (0 != (int(HTuple(hv_Buttons[hv_idx+2])==HTuple("center"))))
      {
    ...
    while (0 != (hv_Exit.TupleNot()))
    {
      ...
      hv_AlphaOrig = HTuple(hv_NumModels,1);
      {
      HTuple end_val460 = (hv_GenParamName.TupleLength())-1;
      HTuple step_val460 = 1;
      for (hv_I=0; hv_I.Continue(end_val460, step_val460); hv_I += step_val460)
      {
        hv_ParamName = HTuple(hv_GenParamName[hv_I]);
        hv_ParamValue = HTuple(hv_GenParamValue[hv_I]);
        //Check if this parameter is understood by set_scene_3d_param
      ...
      PoseToHomMat3d(hv_Poses.TupleSelectRange(0,6), &hv_HomMat3D);
      AffineTransPoint3d(hv_HomMat3D, HTuple(hv_Center[0]), HTuple(hv_Center[1]), 
          HTuple(hv_Center[2]), &hv_Qx, &hv_Qy, &hv_Qz);
      hv_TBCenter.Clear();
      hv_TBCenter.Append(hv_Qx);
      hv_TBCenter.Append(hv_Qy);
      hv_TBCenter.Append(hv_Qz);
      ...
      while (0 != (hv_Exit.TupleNot()))
      {
        ...
        if (0 != (int(hv_Poses!=hv_PreviousSentPose)))
        {
            ...
            if (0 != (int(hv_GraphButton==-1)))
            {
              ...
              try
              {
                ...
                while (0 != 1)
                {
                  ...
                  else if (0 != (int(hv_MessageType==HTuple("exit_fast"))))
                  {
                    //Fast exit - no cleanup of resources! Use only for debugging.
                    return;
                  }
                  else if (0 != (int(hv_MessageType==HTuple("toggle_param"))))
                  {
                    GetMessageTuple(hv_MessageHandle, "param", &hv_ParamName);
                    hv_Pos = hv_OriginalGenParamName.TupleFind(hv_ParamName);
                    if (0 != (HTuple(int(hv_Pos!=-1)).TupleAnd(int(hv_Pos!=HTuple()))))
                    {
                      if (0 != (int(HTuple(hv_OriginalGenParamValue[hv_Pos])==HTuple("true"))))
                      {
                  ...
                  else if (0 != (int(hv_MessageType==HTuple("auto_rotate"))))
                  {
                  ...
                  else if (0 != (int(hv_MessageType==HTuple("set_pose"))))
                  {
                    GetMessageTuple(hv_MessageHandle, "poses", &hv_NewPoses);
                    if (0 != (int((hv_NewPoses.TupleLength())==(hv_Poses.TupleLength()))))
                    {
                      hv_NewPoses = hv_Poses;
                    }
                    else if (0 != (int((hv_NewPoses.TupleLength())==7)))
                    {
                  ...
                  else if (0 != (int(hv_MessageType==HTuple("replace_object_model"))))
                  {
                  ...
                  else if (0 != (int(hv_MessageType==HTuple("force_redraw"))))
                  {
                    hv_Redraw = 1;
                  }
                  else if (0 != (int(hv_MessageType==HTuple("change_button_text"))))
                  {
                    GetMessageTuple(hv_MessageHandle, "index", &hv_ButtonIndex);
                    GetMessageTuple(hv_MessageHandle, "text", &hv_ButtonText);
                    if (0 != (HTuple(int(hv_ButtonIndex>=0)).TupleAnd(int(hv_ButtonIndex<((hv_gButtons.TupleLength())/5)))))
                    {
                  ...
                  else if (0 != (int(hv_MessageType==HTuple("change_title"))))
                  {
              ...
              if (0 != (int(hv_FoundButton>=0)))
              {
                ...
                while (0 != 1)
                {
                  ...
                  if (0 != (int(hv_GraphButton==0)))
                  {
                    check_mouse_over_button(hv_Parameters, hv_GraphButtonRow, hv_GraphButtonColumn, 
                        &hv_FoundButton2);
                    if (0 != (int(hv_FoundButton2==hv_FoundButton)))
                    {
                ...
                if (0 != (int(hv_ButtonPressed>=0)))
                {
                  if (0 != (int(hv_ButtonPressed==hv_ExitButton)))
                  {
                    hv_Exit = 1;
                    break;
                  }
                  else
                  {
                    ...
                    EnqueueMessage(HTuple(hv_MessageQueue[2]), hv_MessageHandle, 
                        HTuple(), HTuple());
                  }
                }
              }
...
void wait_continue_button (HTuple hv_WindowHandle)
{
  ...
  while (0 != 1)
  {
    try
    {
      ...
      if (0 != (HTuple(HTuple(int(hv_Button!=0)).TupleAnd(int(hv_Row>=hv_ButtonRow))).TupleAnd(int(hv_Column>=hv_ButtonCol))))
      {
        break;
      }
    }
...
void write_note (HTuple hv_WindowHandle, HTuple hv_Type, HTuple hv_String)
{
  ...
  if (0 != (int(hv_Type==HTuple("Title"))))
  {

  }
  if (0 != (int(hv_Type==HTuple("none"))))
  {
    WriteString(hv_WindowHandle, HTuple(hv_Strings[0]));
    SetColor(hv_WindowHandle, "white");
  }
  else if (0 != (int(hv_Type==HTuple("instruction"))))
  {
...
static void* _hcppthread_set_edge_parameter_sliders(void *hcthread)
{
  ...
  try
  {
    ...
    const HTuple        &cbhv_WindowHandle = hcppthread->GetInputCtrlParamTuple(0);
    const HTuple        &cbhv_ObjectModel3D = hcppthread->GetInputCtrlParamTuple(1);
    const HTuple        &cbhv_MessageQueues = hcppthread->GetInputCtrlParamTuple(2);
...
void action()
{ ros::NodeHandle m;
  ros::Publisher halcon_pub = m.advertise<std_msgs::String>("halcon_finish_message", 1000);
  ros::Publisher halcon_pub_pose = m.advertise<beginner_tutorials::pose>("halcon_publish_pose", 1000);
  std::cout<<"\n\nsono nella funzione action e mi preparo ad eseguire il programma dopo aver creato il topic halcon_pub";
  std_msgs::String halcon_return_message;
  std::string stringa;
  std::string score;
  std::clock_t start;
  double duration;
  ...
  start = std::clock(); 
  /*std::cout<<"\ndigitare esc per non eseguire il programma";
  ...
  // Local control variables
  HTuple  hv_FileScan, hv_Scan, hv_Status, hv_WindowHandle;
  HTuple  hv_PoseOut, hv_FileViste, hv_View, hv_Status1, hv_Surface,hv_View_1;
  HTuple  hv_MinScore, hv_Pose, hv_Score, hv_SurfaceMatchingResult;
  HTuple  hv_CreateSurfaceModelParamName, hv_CreateSurfaceModelParamValue;
  HTuple  hv_FindSurfaceModelParamName, hv_FindSurfaceModelParamValue;
  
  //parametri di tipo intero e float
  float scene_samp_dist,model_rough_sampling,model_fine_sampling,matching_min_score,matching_samp_distance,keypoint_fraction;

  // dev_update_time(...); only in hdevelop

  //Settaggio Cartelle di Lavoro
  //get_current_dir (DirName)
  //dev_open_file_dialog ('', 'dir', DirName, DirPezzo)
  //PathScansioni := DirPezzo + '/scansioni/'
  //PathViste := DirPezzo + '/viste/'
  //stop ()
  //
  //dev_open_file_dialog ('', 'file', PathScansioni, FileScan)

  // leggo il nome della scena da aprire
  valoreparam = readline(name_file,28,"{","}");
  std::cout << "\nho letto:\t"<<  valoreparam;
  hv_FileScan = valoreparam.c_str(); 

  // leggo scene sampling resolution
  valoreparam = readline(name_file,29,"{","}");
  std::cout << "\nho letto:\t"<<  valoreparam;
  scene_samp_dist = std::stof(valoreparam); 

  // leggo il nome del modello da utilizzare
  valoreparam = readline(name_file,27,"{","}");
  std::cout << "\nho letto:\t"<<  valoreparam;
  hv_FileViste = valoreparam.c_str(); 

  // leggo scene model rough sampling
  valoreparam = readline(name_file,30,"{","}");
  std::cout << "\nho letto:\t"<<  valoreparam;
  model_rough_sampling = std::stof(valoreparam); 

  // leggo scene model fine sampling
  valoreparam = readline(name_file,31,"{","}");
  std::cout << "\nho letto:\t"<<  valoreparam;
  model_fine_sampling = std::stof(valoreparam); 

  // leggo minimum matching score
  valoreparam = readline(name_file,32,"{","}");
  std::cout << "\nho letto:\t"<<  valoreparam;
  matching_min_score = std::stof(valoreparam); 

  // leggo maching sample distance
  valoreparam = readline(name_file,33,"{","}");
  std::cout << "\nho letto:\t"<<  valoreparam;
  matching_samp_distance = std::stof(valoreparam); 

  // leggo keypoint fraction
  valoreparam = readline(name_file,34,"{","}");
  std::cout << "\nho letto:\t"<<  valoreparam;
  keypoint_fraction = std::stof(valoreparam); 

 


  ReadObjectModel3d(hv_FileScan, "m", HTuple(), HTuple(), &hv_Scan, &hv_Status);
  //SelectPointsObjectModel3d(hv_Scan, "point_coord_z", 1500, 2500, &hv_Scan);
  //select_points_object_model_3d (Scan, 'point_coord_x', -350, 150, Scan)
  //select_points_object_model_3d (Scan, 'point_coord_y', -500, 300, Scan)
  SampleObjectModel3d(hv_Scan,"accurate",scene_samp_dist,HTuple(),HTuple(),&hv_Scan);
  //SurfaceNormalsObjectModel3d(hv_Scan, "mls", HTuple(), HTuple(), &hv_Scan);
  //SetWindowAttr("background_color","black");
  //OpenWindow(0,0,512,512,0,"visible","",&hv_WindowHandle);
  //HDevWindowStack::Push(hv_WindowHandle);
  //visualize_object_model_3d(hv_WindowHandle, hv_Scan, HTuple(), HTuple(), "disp_normals", 
  //    "true", HTuple(), HTuple(), HTuple(), &hv_PoseOut);
  //if (HDevWindowStack::IsOpen())
  //  CloseWindow(HDevWindowStack::Pop());
  //SetWindowAttr("background_color","black");
  //OpenWindow(0,0,512,512,0,"visible","",&hv_WindowHandle);
  //HDevWindowStack::Push(hv_WindowHandle);
  //DispObjectModel3d(hv_WindowHandle, hv_Scan, HTuple(), HTuple(), "disp_normals", 
  //    "true");
  //write_object_model_3d(Scan,'ply_binary',"pezzo_1_norm.ply")
  //write_object_model_3d (Scan, 'ply_binary', 'C:/Users/Loris/Desktop/project work/Matching/Pezzo 1/pezzo_1_normali.ply', 'invert_normals', 'false')
  //stop ()
  //dev_open_file_dialog ('', 'file', PathViste, FileViste)
  

; //modello

    ReadObjectModel3d(hv_FileViste, "m", HTuple(), HTuple(), &hv_View, &hv_Status1);
  //SurfaceNormalsObjectModel3d(hv_View, "mls", HTuple(), HTuple(), &hv_View);
  //SetWindowAttr("background_color","black");
  //OpenWindow(0,0,512,512,0,"visible","",&hv_WindowHandle);
  //HDevWindowStack::Push(hv_WindowHandle);
  //visualize_object_model_3d(hv_WindowHandle, hv_View, HTuple(), HTuple(), "disp_normals", 
  //   "true", HTuple(), HTuple(), HTuple(), &hv_PoseOut);

  //if (HDevWindowStack::IsOpen())
  //  CloseWindow(HDevWindowStack::Pop());
  //write_object_model_3d (View, 'ply_binary', 'C:/Users/Loris/Desktop/project work/Matching/Pezzo 1/modello1_normali.ply', 'invert_normals', 'true')
  CreateSurfaceModel(hv_View, model_rough_sampling, "pose_ref_rel_sampling_distance", model_fine_sampling, &hv_Surface);
  //create_surface_model (View, 0.01, ['model_invert_normals'], ['true'], Surface)
  //stop ()
  //ROS_INFO("riga 9990");
  ...
  //find_surface_model (Surface, Scan, 0.02, 0.2, MinScore, 'true', ['num_matches', 'pose_ref_use_scene_normals'], [20, 'true'], Pose, Score, SurfaceMatchingResult)
  FindSurfaceModel(hv_Surface, hv_Scan, matching_samp_distance, keypoint_fraction, matching_min_score, "true", "num_matches", 
      1, &hv_Pose, &hv_Score, &hv_SurfaceMatchingResult);
  score = hv_Score.ToString();

  // estraggo posizione e rotazione della pinza
  ...
  pose_msg.pos_x = pose[0];
  pose_msg.pos_y = pose[1];
  pose_msg.pos_z = pose[2];
  pose_msg.rot_x = pose[3];
  pose_msg.rot_y = pose[4];
  pose_msg.rot_z = pose[5];
  
  //pubblico la posa

  halcon_pub_pose.publish(pose_msg);

  //pubblico messaggio di fine matching


  // salvo i dati 


  std::cout<<"\nlo score vale: "<<score<<std::endl;
  duration = ( std::clock() - start ) / (double) CLOCKS_PER_SEC;
  std::cout << "\nOperation took "<< duration << "seconds\n" << std::endl;
  myfile << "\t" << score << "\t" << duration;
  myfile << "\t" << pose[0] << "\t" << pose[1] << "\t" << pose[2] << "\t" << pose[3] << "\t" << pose[4] << "\t" << pose[5] <<"\n";
  myfile.close();

  // Apro la finestra di visualizzazione
  //ROS_INFO("riga 10005");
  RigidTransObjectModel3d(hv_View,hv_Pose,&hv_View_1);
  SetWindowAttr("background_color","black");
  OpenWindow(0,0,800,800,0,"visible","",&hv_WindowHandle);
  HDevWindowStack::Push(hv_WindowHandle);
  visualize_object_model_3d(hv_WindowHandle, hv_Scan.TupleConcat(hv_View_1), HTuple(), 
      HTuple(), ((HTuple("disp_normals").Append("colored")).Append("disp_background")), 
      ((HTuple("true").Append(12)).Append("false")), HTuple(), HTuple(), HTuple(), 
      &hv_PoseOut);
  if (HDevWindowStack::IsOpen())
    CloseWindow(HDevWindowStack::Pop());
  ...
  halcon_return_message.data = "matching finished";
  halcon_pub.publish(halcon_return_message);
  std::cout<<"\n\n *******************************************************\n";
  std::cout << halcon_return_message.data << "and score saved";
  //debug_find_surface_model(hv_Surface, hv_View, hv_Scan, hv_SurfaceMatchingResult, 
  //    &hv_CreateSurfaceModelParamName, &hv_CreateSurfaceModelParamValue, &hv_FindSurfaceModelParamName, 
  //    &hv_FindSurfaceModelParamValue);
...
#endif
void chatterCallback(const beginner_tutorials::coord_msg_checked::ConstPtr& msg_da_pubb)
{ 
  ROS_INFO("I heard the message");
  std::cout<<"la x vale:" << msg_da_pubb->x <<"\n";
  std::cout<<"la y vale:" << msg_da_pubb->y <<"\n"; 
  std::cout<<"la z vale:" << msg_da_pubb->z <<"\n";
  std::cout<<"la qx vale:" << msg_da_pubb->x <<"\n";
  std::cout<<"la qy vale:" << msg_da_pubb->y <<"\n"; 
  std::cout<<"la qz vale:" << msg_da_pubb->z <<"\n";
  std::cout<<"la qw vale:" << msg_da_pubb->z <<"\n";
  std::cout<<"la pianificazione vale:" << msg_da_pubb->check <<"\n"; 
  dir_dati_salv = readline(name_file,37,"{","}");
  if(only_one == 0){
    tempo = GetCurrentTimeForFileName();
    only_one =1;
  }
  nome_file_completo = dir_dati_salv+nome_file_halcon+tempo+estensione;
  std::cout << "\n\n ------------------------------------------";
  std::cout <<"\n nome file:  " << nome_file_completo;
  myfile.open(nome_file_completo,std::ios::app);
  myfile << std::setprecision(2) << std::fixed;
  myfile<< msg_da_pubb->x << "\t" <<  msg_da_pubb->y << "\t"<< msg_da_pubb->z;
  myfile << std::setprecision(5) << std::fixed;
  myfile<< "\t" << msg_da_pubb->qx<< "\t"<< msg_da_pubb->qy<< "\t"<< msg_da_pubb->qz<< "\t"<< msg_da_pubb->qw;
  myfile<< "\t" << msg_da_pubb->check;
  std::cout<<"\ncoordinates saved";
  action();
  }
int main(int argc, char *argv[])
{
  ...
  ros::NodeHandle n;
  ros::Subscriber sub = n.subscribe("halcon_consensus", 1000, chatterCallback);
