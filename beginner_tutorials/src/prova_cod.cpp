...
void action()
{
  ...
  HTuple  hv_PoseOut, hv_FileViste, hv_View, hv_Status1, hv_Surface;
  ...
  hv_FileScan = "/home/loris/Scaricati/ruota_scansione.ply";
  ...
  hv_FileViste = "/home/loris/Scaricati/ruota_modello_1.ply";
  ReadObjectModel3d(hv_FileViste, "mm", HTuple(), HTuple(), &hv_View, &hv_Status1);
  ...
  CreateSurfaceModel(hv_View, 0.03, HTuple(), HTuple(), &hv_Surface);
  ...
  FindSurfaceModel(hv_Surface, hv_Scan, 0.05, 0.8, hv_MinScore, "true", "num_matches", 
      1, &hv_Pose, &hv_Score, &hv_SurfaceMatchingResult);
  ROS_INFO("matching finito");
